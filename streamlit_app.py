...
with tab1:
    ...
    # Тооллогын хүснэгт бараг л хоосон байхад санамсаргүйгээр "Тулгалт хийх"
    # дарж, буруу (хоосон) үр дүн гаргахаас сэргийлнэ.
    meaningful_rows = int((edited_df["Нэр"].str.strip() != "").sum())
    if meaningful_rows == 0:
        st.warning(
            "⚠️ Дээрх тооллогын хүснэгт **бүрэн хоосон** байна. Эхлээд дээш гарч "
            "'📥 Тооллогыг Excel файлаас ачаалах' хэсгээр өөрийн тооллогын Excel-ээ "
            "ачаалах, эсвэл хүснэгтэд гараар өгөгдөл оруулна уу — эс тэгвээс "
            "тулгалт хоосон мөрүүдээр хийгдэх болно."
        )
    elif meaningful_rows < 5:
        st.info(
            f"ℹ️ Дээрх тооллогын хүснэгтэд ердөө **{meaningful_rows}** барааны нэртэй мөр "
            f"байна. Хэрэв энэ тоо танай бодит тооллогоос (жишээ нь 40 бараа) бага байвал, "
            f"'📥 Тооллогыг Excel файлаас ачаалах' хэсгээр эхлээд бүх тооллогоо ачаалсан "
            f"эсэхээ шалгана уу."
        )
